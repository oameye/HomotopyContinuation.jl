...
@testset "Homotopies" begin
    @testset "ParameterHomotopy" begin
        ...
        H = ParameterHomotopy(F, p, q; compile = Val(:none))
    ...
    @testset "StraightLineHomotopy" begin
        ...
        G = System(g, [x, y])
        H = StraightLineHomotopy(F, G; compile = Val(:none))
    ...
    @testset "ExtrinsicSubspaceHomotopy" begin
        ...
        H = ExtrinsicSubspaceHomotopy(fixed(F; compile = Val(:none)), A, B; gamma = nothing)
    ...
    @testset "IntrinsicSubspaceHomotopy" begin
        ...
        A = rand_subspace(4; codim = 2)
        B = rand_subspace(4, codim = 2)
        H = IntrinsicSubspaceHomotopy(fixed(F; compile = Val(:none)), A, B; gamma = nothing)
    ...
    @testset "CoefficientHomotopy" begin
        ...
        H = CoefficientHomotopy(F, p, q; compile = Val(:none))
