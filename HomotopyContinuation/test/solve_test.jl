@testset "solve" begin
    ...
    @testset "total degree (simple)" begin
        ...
        @test count(is_success, track.(total_degree(affine_sqr; compile = Val(:none))...)) == 2
        ...
        @test count(is_success, track.(total_degree(proj_square; compile = Val(:none))...)) == 4
        ...
        @test count(is_success, track.(total_degree(affine_ov; compile = Val(:none))...)) == 2
        ...
        tracker, starts = total_degree(affine_ov_reordering; compile = Val(:none))
        ...
        @test count(is_success, track.(total_degree(proj_ov; compile = Val(:none))...)) == 2
        ...
        tracker, starts = total_degree(proj_ov_reordering; compile = Val(:none))
        @test length(starts) == 4 * 3
        @test count(is_success, track.(tracker, starts)) == 2
    ...
    @testset "total degree (variable groups)" begin
        ...
        tracker, starts = total_degree(affine_sqr; compile = Val(:none))
        ...
        tracker, starts = total_degree(affine_ov; compile = Val(:none))
        @test count(is_success, track.(tracker, starts)) == 2
        @var x y v w
        proj_ov = System(
        ...
        tracker, starts = total_degree(proj_ov; compile = Val(:none))
        @test count(is_success, track.(tracker, starts)) == 2
    end
    ...
    @testset "polyhedral" begin
        ...
        @test count(is_success, track.(polyhedral(affine_sqr; compile = Val(:none))...)) == 2
        ...
        @test count(is_success, track.(polyhedral(proj_square; compile = Val(:none))...)) == 4
        ...
        @test count(is_success, track.(polyhedral(affine_ov; compile = Val(:none))...)) == 2
        ...
        @test count(is_success, track.(polyhedral(proj_ov; compile = Val(:none))...)) == 2
    ...
    @testset "composition" begin
        ...
        res = solve(e ∘ f ∘ g; start_system = :total_degree, compile = Val(:none))
    ...
    @testset "solve (affine sliced)" begin
        ...
        @var x y
        r1 = solve(F; target_subspace = l1, compile = Val(:none))
