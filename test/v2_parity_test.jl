...
@testset "v2 Parity" begin
    ...
    @testset "DynamicPolynomials: high-degree system (18 solutions)" begin
        ...
        result = solve(System([f₁, f₂]), TotalDegree(; show_progress = false))
    ...
    @testset "parameter homotopy: affine" begin
        ...
        r1 = solve(F_start, TotalDegree(; show_progress = false))
    ...
    @testset "Wilkinson-12" begin
        ...
        result = solve(
            System([f]),
            TotalDegree(;
                endgame_options = EndgameOptions(; only_nonsingular = true),
                show_progress = false,
            ),
        )
